...
>Jadi Kode ini menukar posisi tiga string yang dimasukkan oleh pengguna secara bergantian sesuai pola:  
**A → B, B → C, C → A.**
...
![](output/soal2.a.png)
>Kode ini menentukan apakah tahun yang dimasukkan adalah **kabisat** atau tidak dengan menggunakan aturan pembagian angka. Tahun kabisat adalah tahun yang memenuhi salah satu dari dua kondisi berikut:

>1. Habis dibagi **400**.
>2. Habis dibagi **4** tetapi **tidak habis dibagi 100**.
#### Soal 3
...
> - Program ini membaca **jari-jari bola** dari input pengguna.
- Menghitung **volume** dan **luas permukaan** bola menggunakan rumus matematika.
- Menampilkan hasil dengan **4 angka desimal** untuk ketelitian.
...
Kode ini mengubah suhu dari **Celsius** ke **Reamur, Fahrenheit, dan Kelvin** dengan rumus konversi yang sesuai.
...
- Program ini membaca **lima angka**, menafsirkannya sebagai karakter ASCII, lalu mencetaknya.
- Program juga membaca **tiga karakter**, menaikkan nilai **ASCII**-nya **sebesar 1**, lalu mencetaknya kembali.
- **Fungsi utama** dari program ini adalah **konversi kode ASCII ke karakter** dan **perubahan karakter berdasarkan nilai ASCII**.
### Soal Latihan 2B
